...
#IMP: with this script you can generate different files, distance files just containing the numeric results to be processed with pandas 
# data frame, or the files with numeric results and respective pdb file name. The initial list of pdb files to look at is generated randomly,
# and this means the number of the structures is not well ordered from number 1 to 19. 
...
Path = "/home/veronica/Cluster/2022/May2022/KOURIST/IsoprenylAcetate/Docking_Script02/Docking_secondTime/Distances_from_FI2_FI3/"
filelist = os.listdir(Path)
for x in filelist:
    if x.startswith("sol_1.ref_0"):
        ...
        with open (x) as fout:
            for riga in fout:
                ...
                if riga.startswith("HETATM") and riga.split()[2]=="C6":
                   ...
                   # file1.write(str(dist_FI2_C6) + "," + str(x) + '\n')
        ...
        with open (x) as fout:
            for riga in fout:
                ...
                if riga.startswith("HETATM") and riga.split()[2]=="C6":
                    ...
                    #file2.write(str(dist_FI3_C6) + "," + str(x) + '\n')
        ...
        with open (x) as fout:
            for riga in fout:
                ...
                if riga.startswith("HETATM") and riga.split()[2]=="C5":
                    ...
                    #file3.write(str(dist_FI2_C5) + "," + str(x) + '\n')
        ...
        with open (x) as fout:
            for riga in fout:
                ...
                if riga.startswith("HETATM") and riga.split()[2]=="C5":
                    ...
                    #file4.write(str(dist_FI3_C5) + "," + str(x) + '\n')
